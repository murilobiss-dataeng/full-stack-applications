      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:gap-10">
        <div className="lg:col-span-1">
          ...
          <p className="mt-2 max-w-xs text-xs leading-relaxed">
            Murilo Biss · Snowflake-first Data Engineering narrative in the open: pipeline optimization, warehouse modeling, tests
            and lineage, and a thin governed metrics boundary for analytics consumers.
          </p>
          <p className="mt-2 max-w-xs text-[11px] leading-relaxed text-muted-foreground/90">
            <strong className="text-foreground">{DEMO_MARKETPLACE_BRAND}</strong> is a fictional regulated enterprise analytics
            program used only in this portfolio. Not affiliated with Sigma Software’s clients or any real manufacturer.
          </p>
        </div>

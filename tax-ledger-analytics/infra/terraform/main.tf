...
# Uncomment the blocks below when binding to a real account and remote state.
#
# terraform {
...
# Intentionally minimal: validates repo layout; use iam-outline.tf for permission notes.

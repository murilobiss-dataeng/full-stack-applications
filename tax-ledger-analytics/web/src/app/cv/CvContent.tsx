...
const experienceRoles: CvExperienceRole[] = [
  ...
  },
  {
    ...
    location: "Curitiba and region, Brazil",
    bullets: [
      "Regional cosmetics distribution; key accounts, technical team, marketing for Visat Hair Group portfolio.",
      "Planning and control: sales, inventory, productivity indicators.",
    ],
    accent: "from-muted/40 to-transparent",
  ...
  },
  {
    ...
    bullets: ["Support to production methods, process documentation, supplier support."],
    accent: "from-muted/40 to-transparent",
    tags: ["QA"],
  },
  {
    ...
    location: "Curitiba",
    bullets: ["Site monitoring, measurements, planning and production control."],
    accent: "from-muted/40 to-transparent",
    tags: [] as const,
  },
  {
    org: "Plaenge Empreendimentos",
    title: "Engineer Trainee",
    period: "Jan 2009 — Dec 2009",
    location: "Curitiba",
    bullets: ["PBQP-H monitoring, quantity surveys, site inspection."],
    accent: "from-muted/40 to-transparent",
    tags: [],
  },
  {
    ...
    period: "Oct 2007 — Sep 2008",
    location: "Quatro Barras",
    bullets: ["5S program, production methods support, process improvement."],
    accent: "from-muted/40 to-transparent",
    tags: [] as const,
  },
];

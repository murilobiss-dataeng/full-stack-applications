...
export default function QuemSomosPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-700 via-brand-600 to-brand-800 px-6 py-14 text-white shadow-xl sm:px-12">
      ...
      <section className="mt-16">
        <h2 className="mb-8 text-center font-serif text-2xl font-bold text-slate-900 dark:text-white sm:text-3xl">
          Nossos pilares
        </h2>
        <ValueCards />
      </section>

      <section className="mt-16 rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm dark:border-slate-700 dark:bg-slate-900 sm:p-12">

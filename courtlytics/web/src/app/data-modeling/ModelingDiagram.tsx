...
const flow: { from: NodeId; to: NodeId; caption: string }[] = [
  { from: "courts", to: "cases", caption: "cases.court_id → courts.court_id (venue grain)" },
  { from: "lawyers", to: "bridge", caption: "case_lawyer.lawyer_id → lawyers.lawyer_id" },
  { from: "cases", to: "bridge", caption: "case_lawyer.case_id → cases.case_id" },
];

const nodes: { id: NodeId; title: string; subtitle: string }[] = [
  { id: "courts", title: "courts", subtitle: "dimension" },
  { id: "lawyers", title: "lawyers", subtitle: "dimension + golden id" },
  { id: "cases", title: "cases", subtitle: "fact" },
  { id: "bridge", title: "case_lawyer", subtitle: "many-to-many" },
];
